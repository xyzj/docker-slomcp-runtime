...
SVR_START = {
    ...
    "back": "start-stop-daemon --start --background -d /opt/bin -m -p /run/back.pid --exec /opt/bin/backend -- -conf=backend.conf -http=6819 -portable",
    ...
    "ecms": "start-stop-daemon --start --background -d /opt/bin -m -p /run/ecms.pid --exec /opt/bin/ecms-mod -- -conf=ecms.conf -http=6830 -tcp=6828 -portable -forcehttp",
